...
def run_pin_framework(pkl_file, phenomenon="pendulum"):
    """
    ...
    if phenomenon == "pendulum":
        ...
        trajectories = FreeFallPINN.load_trajectories(pkl_file)
        FreeFallPINN.evaluate(trajectories, output_dir)
    elif phenomenon == "projectile":
        print("[Framework] Running Projectile PINN.")
        trajectories = ProjectilePINN.load_trajectories(pkl_file, kernel_size=11, apply_smoothing=True)
